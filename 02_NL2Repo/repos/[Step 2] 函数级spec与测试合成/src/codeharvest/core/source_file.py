...
class FileRecord(BaseModel):
    ...
    @classmethod
    def from_file_path(cls, file_path: str, repo: RepoRecord | None) -> "FileRecord":
        file_module = ModuleRecord.from_file_path(file_path, repo=repo)
