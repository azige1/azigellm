...
class FileCallableExtractor:
    ...
    def filter_keep_docstring(
        ...
        return [
            function_ast
            for function_ast in function_asts
            if FileCallableExtractor.has_docstring(function_ast)
        ]
    ...
    def filter_literal_returns(
        ...
        return [
            function_ast
            for function_ast in function_asts
            if not FileCallableExtractor.has_literal_return(function_ast)
        ]
    ...
    def filter_docstring_keywords(
        ...
        return [
            function_ast
            for function_ast in function_asts
            if FileCallableExtractor.get_docstring_tokens_lowered(function_ast).isdisjoint(
                BAD_DOC_SUBSTRINGS
            )
        ]
    ...
    def filter_func_body_keywords(
        ...
        return [
            function_ast
            for function_ast in function_asts
            if FileCallableExtractor.get_func_body_tokens_lowered(function_ast).isdisjoint(
                BAD_CODE_SUBSTRINGS
            )
        ]
    ...
    def filter_bad_function_names(
        ...
        return [
            function_ast
            for function_ast in function_asts
            if not FileCallableExtractor.filter_bad_function_name(function_ast)
        ]
