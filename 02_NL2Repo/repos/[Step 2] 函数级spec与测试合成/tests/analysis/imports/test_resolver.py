...
class TestImportResolver(unittest.TestCase):
    ...
    def test_absolute_import_module_item(self):
        ...
        resolved_path = ImportPathResolver.resolve_module_path(test_file_path, import_node)
    ...
    def test_relative_import_across_packages(self):
        ...
        resolved_path = ImportPathResolver.resolve_module_path(module1_path, import_node)
    ...
    def test_relative_import_package_in_repo(self):
        ...
        resolved_path = ImportPathResolver.resolve_module_path(sample_path, import_node)
    ...
    def test_absolute_import_src_in_repo(self):
        ...
        resolved_path = ImportPathResolver.resolve_module_path(color_path, import_node)
