...
from codeharvest.analysis.slicing.globals.statements import stmt_global_names

class TestStmtGlobalsFinder(unittest.TestCase):
    def build_ast_getstmt_globals(self, code: str):
        node = ast.parse(code).body[0]
        return stmt_global_names(node)  
...
def f(a : str, f_arg : int, arg2):
    ...
    def func2(a: Literal['gpt'], b: "ClassRecord" = GLOBAL_CLASS_INSTANCE):
        class A(B):
